...
source(here::here("R", "site_url.R"))
ical_url_absolute <- course_site_url(schedule_ical_file)
```
...
- [**Example**](example/index.qmd) ({{< fa laptop-code >}}): This page contains fully annotated R code that you can use as a reference for creating your own visualizations. You do not need to complete anything on this page. Each section also includes live-coding videos that demonstrate how the examples are created in R. This page will be especially helpful as you work on your assignments.

- [**Assignment**](assignment/index.qmd) ({{< fa pen-ruler >}}): This page contains instructions for each session exercise (typically 1–3 brief tasks), the two mini projects, and the final project. Assignments are due by 11:59 PM on the dates listed in the course schedule. See the schedule below for specific deadlines.
