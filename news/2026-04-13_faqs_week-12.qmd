...
I use {targets} for all my projects ([including this course website!](https://github.com/sneupane2/dataviz-pmap-8551#targets-pipeline)) and it makes life a ton easier for any kind of project that involves more than one .qmd file or R script ([see this for an example](https://stats.andrewheiss.com/mountainous-mackerel/analysis/targets.html)). I *highly* recommend checking it out.
:::
