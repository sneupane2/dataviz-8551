...
2. You included other content earlier in the chunk. [Remember from this](2026-02-17_faqs_week-05.qmd#i-specified-chunk-options-like-fig-width-but-they-didnt-work-and-they-appeared-in-the-documentwhy) that chunk options *must* be the first things inside a chunk.
...
```{r}
wday(x, label = TRUE, abbr = FALSE, locale = "en_US.UTF-8")
wday(x, label = TRUE, abbr = FALSE, locale = "fr_FR.UTF-8")
wday(x, label = TRUE, abbr = FALSE, locale = "fr_BE.UTF-8")
wday(x, label = TRUE, abbr = FALSE, locale = "it_IT.UTF-8")
wday(x, label = TRUE, abbr = FALSE, locale = "zh_CN.UTF-8")
```

### Months

```{r}
month(x, label = TRUE, abbr = FALSE, locale = "en_US.UTF-8")
month(x, label = TRUE, abbr = FALSE, locale = "fr_FR.UTF-8")
month(x, label = TRUE, abbr = FALSE, locale = "fr_BE.UTF-8")
month(x, label = TRUE, abbr = FALSE, locale = "it_IT.UTF-8")
month(x, label = TRUE, abbr = FALSE, locale = "zh_CN.UTF-8")
```
