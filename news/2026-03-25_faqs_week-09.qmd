...
A couple weeks ago there was [a related FAQ about all R packages](2026-03-03_faqs_week-07.qmd#is-there-some-place-i-can-find-r-packages-there-are-so-many), and I gave you some helpful strategies for finding R packages in general.
...
In the FAQs for session 5, [I mentioned the `theme_set()` function](2026-02-17_faqs_week-05.qmd#theme_set), which lets you set a theme for all plots in a document:
