...
There are no rules! [See this FAQ post from week 1 for more](2026-01-26_faqs_week-01.qmd#my-histogram-bars-are-too-wide-too-narrow-not-visible.-how-do-i-fix-that).
...
Like, let's say you forget that you need to use `+` in between ggplot layers and you use a pipe (`|>`) instead ([remember the difference here](2026-02-03_faqs_week-03.qmd#why-do-we-sometimes-combine-code-with-and-sometimes-with)).
...
I'll use that same theme throughout a project. Typing all those little theme tweaks is annoying, but you can reuse them—[see this FAQ from week 5](2026-02-17_faqs_week-05.qmd#if-i-want-to-use-the-same-theme-for-all-the-plots-in-my-document-do-i-need-to-reuse-all-that-code-all-the-time)!
