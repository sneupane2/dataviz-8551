...
Write your [session check-in](session-check-in.qmd) for the session's readings.
...
Here's a typical poster you might see in your workplace or on campus. (Here’s an example of a poster that was displayed on campus at 55 Park Place)

**Do the four tasks below while consulting this poster**

```{r project-structure, echo=FALSE, out.width="90%", fig.align="center"}
knitr::include_graphics(here::here("projects", "02-exercise", "excen-flyer.jpg"), error = FALSE)
```
...
[As part of building class community](../news/2026-01-05_building-community.qmd), consider showing your redesigned poster to classmates and discussing the choices you made!
:::
