...
Each session you'll submit a list of three most interesting and three most unclear things from the readings. ([See the complete instructions and details here](session-check-in.qmd)).
...
- ✔−: (*5 points (50%) in gradebook*) Exercises are less than 70% complete and/or most answers are incorrect. This indicates that you need to improve next time. Most students who engage with the course and make a genuine effort should expect to earn a ✓.

Note that this is also essentially a pass/fail system. I'm not grading your coding ability, I'm not checking each line of code to make sure it produces some exact final figure, and I'm not looking for perfect. Also note that a ✓ does not require 100% completion—you will sometimes get stuck with weird errors that you can't solve. I'm looking for good faith effort, that's all. Try hard, do good work, and you'll get a ✓. In iCollege, these checks are recorded as the equivalent point values.
...
At some point before the end of the semester, you'll need to (1) take a dataset, (2) do something neat with it, and (3) share it with the public somehow. ([See the complete instructions and details here](tidy-tuesday.qmd)).
...
[Complete details for the final project (including past examples of excellent projects) are here.](final-project.qmd)
