...
- **Visualize Data**
  ...
  - [Histograms](https://r-primers.andrewheiss.com/visualize-data/03-histograms/)
    - **Reference video:** [Histograms in R](https://www.youtube.com/watch?v=n_ACYLWUmos)
  - [Boxplots and counts](https://r-primers.andrewheiss.com/visualize-data/04-boxplots/)
    - **Reference video:** [Boxplots (`geom_boxplot()`)](https://www.youtube.com/watch?v=C3luN5NBmho&t=84s)
