...
## Programming Basics videos
    ...
    Some videos embedded in the Programming Basics page are no longer available from the original source. The rest of the page is still useful, so continue using it. You can use the following videos as additional references for these topics:
