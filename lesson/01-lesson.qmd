...
For the first part of this week's lesson, work through the introductory materials below. You'll do these in your browser, where you can type R code and see the results.

These materials introduce some of the basics of R, along with useful tools for working with data using the {dplyr} package.

There are several sections, but they're short and go fairly quickly. **I have no way of seeing what you do or what you get wrong or right**, and that's totally fine! The goal is to practice and become familiar with R. If you get stuck on something, you can move on and come back to it later.
...
- **The Basics**
  ...
  - [Programming basics](https://r-primers.andrewheiss.com/basics/02-programming-basics/)
    ...
    Note: Some videos embedded in the Programming Basics page are no longer available from the original source. The rest of the page is still useful, so continue using it. You can use the following videos as additional references for these topics:

    - [Vectors in R](https://www.youtube.com/watch?v=CBueHBi-ezw)
    - [Functions and objects in R](https://www.youtube.com/watch?v=hvFBDmT4bdY&t=3s)
    - [Data types in R](https://www.youtube.com/watch?v=VtUVQWl0aRA)
    - [Lists in R](https://www.youtube.com/watch?v=X8lNTDeiKiE)
- **Work with Data**
...
knitr::include_graphics(here::here("files", "img", "lesson", "working-directory.png"), error = FALSE)
```
